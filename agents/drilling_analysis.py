...
def main():
    print("=== DRILLING DATASET ANALYSIS WITH SOLUTION TRACKING ===")

    wine_qt = pd.read_csv('Drilling3Classes_VM3_71attr_67rec.csv')
    ...
    initial_state = {
        "data_file_path": "Drilling3Classes_VM3_71attr_67rec.csv",
        "data_summary": data_summary,
        "user_objective": "I want to classify drilling with accuracy of 90% with 10-fold cross validation",
        "iteration_count": 0,
        "max_iterations": 10,
        "improvement_history": [],
        "messages": [],
